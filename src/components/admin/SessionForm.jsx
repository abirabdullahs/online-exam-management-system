...
export default function SessionForm({ onSubmit, initialData, onCancel }) {
    ...
    <form onSubmit={handleSubmit} className="flex flex-wrap gap-3 items-end">
      <div>
        ...
        <input
          ...
          required
          className="px-3 py-2 border border-slate-300 rounded-lg w-32 focus:ring-2 focus:ring-indigo-500"
          placeholder="e.g. SSC or HSC"
        />
      </div>
      <div>
